...
void setup() 
{
  ...
  for (port = 0; port < NUM_COLOR_SENSORS; port++)
  {
    ...
    whiteProfile[port][0]  = 30;
    redProfile[port][0]    = 20;
    greenProfile[port][0]  = 120;
    yellowProfile[port][0] = 60;

    //Profile saturations
    blackProfile[port][1]  = 0.37;
    whiteProfile[port][1]  = 0.15;
    redProfile[port][1]    = 0.37;
    greenProfile[port][1]  = 0.37;
